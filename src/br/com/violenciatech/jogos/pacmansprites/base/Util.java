package br.com.violenciatech.jogos.pacmansprites.base;
...
public class Util {
	public static boolean colide(Elemento a, Elemento b) {
		...
		if (plA > b.getPx() && a.getPx() < plB && paA > b.getPy() && a.getPy() < paB) return true;
	...
	public static boolean saiu(Elemento e, int largura, int altura) {
		if (e.getPx() < 0 || e.getPx() + e.getLargura() > largura) return true;
		if (e.getPy() < 0 || e.getPy() + e.getAltura() > altura) return true;
