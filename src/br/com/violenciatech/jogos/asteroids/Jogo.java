...
public class Jogo extends JFrame{
	...
	public enum Tecla{ CIMA, BAIXO, ESQUERDA, DIREITA,BA, BB, BC }
	...
	public void carregarJogo() {
		fundo = new ImageIcon("imagens/asteroids/fundo.png");
		...
		while(true) {
			...
			if(agora>=prxAtualizacao) {
				...
				if(cenario==null) {
					...
					if(!Jogo.pausado) cenario.atualizar();
	...
	private static void setaTecla(int tecla, boolean pressionada) {
		switch(tecla) {
			case KeyEvent.VK_UP: controleTecla[Tecla.CIMA.ordinal()] = pressionada; break;
			case KeyEvent.VK_DOWN: controleTecla[Tecla.BAIXO.ordinal()] = pressionada; break;
			case KeyEvent.VK_LEFT: controleTecla[Tecla.ESQUERDA.ordinal()] = pressionada; break;
			case KeyEvent.VK_RIGHT: controleTecla[Tecla.DIREITA.ordinal()] = pressionada; break;
			case KeyEvent.VK_ESCAPE: controleTecla[Tecla.BB.ordinal()] = pressionada; break;
			case KeyEvent.VK_ENTER: controleTecla[Tecla.BA.ordinal()] = pressionada; break;
			case KeyEvent.VK_SPACE: controleTecla[Tecla.BC.ordinal()] = pressionada;
		}
	}
}